...
function Menu() {
  return (
    <div className='container ps-4 pe-4 p-3 '>
       ...
       <div className='col-8 wd bt mt-1'><h4 className='ps-4 pop'>Top's & Tee's</h4></div><div className='col-4 bt wd mt-1'><img className='mt-1 ms-4' src={topt}alt="f" height={90}/></div>
       <div className='col-8 wd dg mt-1'><h4 className='ps-4 pop'>Traditional Wear</h4></div><div className='col-4 dg wd mt-1'><img className='mb-1 ms-4' src={trad}alt="f" height={95}/></div>
